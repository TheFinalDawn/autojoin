...
public class GuiHandler {
	...
	private Button disableBackButton;
	private @Nullable Button mainMenuButtonMulti;

	private MultiplayerScreen lastGuiMultiplayer;

	private boolean isFirstOpen = true;

	private boolean isMainMenu(final @Nullable Screen screen) {
		return screen instanceof MainMenuScreen||screen!=null&&StringUtils.equals("lumien.custommainmenu.gui.GuiCustom", screen.getClass().getName());
	}
